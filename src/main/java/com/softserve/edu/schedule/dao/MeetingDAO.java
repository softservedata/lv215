...
public interface MeetingDAO extends CrudDAO<Meeting> {
	 ...
	 */
	List<Meeting> getMeetingPageWithFilter(MeetingFilter meetingFilter, Paginator meetingPaginator);
	 ...
	 */
	List<Meeting> dublicatesOfGivenFields(String subjectName, String ownerName, String roomName, LocalDate localDate,
			LocalTime localTime);
	 ...
	 */
	List<Meeting> getMeetingsInIntervalByGroupId(Long groupId, LocalDate startDate, LocalDate endDate);
