...
/**
 * Used to work with filter parameters, sorting and searching features.
 * 
 * @author Andrew
 *
 */
public class UserGroupFilterSpecification implements Specification<UserGroup> {
	...
	/**
	 * Forms predicate from a userGroup filter.
	 */
	@Override
	...
	/**
	 * Setting sorting parameters to fields from a userGroupFilter.
	 * 
	 * @param root
	 *            a root type
	 * @param criteriaQuery
	 *            criteria query to add sorting order.
	 * 
	 * @param criteriaBuilder
	 *            criteria builder of predicate.
	 */
