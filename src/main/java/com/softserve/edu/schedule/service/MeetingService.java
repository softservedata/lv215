...
public interface MeetingService {
	 ...
	 */
	List<MeetingDTO> getMeetingPageWithFilter(MeetingFilter meetingFilter, Paginator meetingPaginator);
	 ...
	 */
	List<MeetingForCalendarDTO> getMeetingsInIntervalByGroupId(Long groupId, String start, String end);
	 ...
	 */
	Map<String, Long> getMeetingsForChartInIntervalByUserId(String userId, String start, String end);
}
