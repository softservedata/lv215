...
public class UserGroupController
        implements ControllerConst.UserGroupControllerConst {
    ...
    public String sortByNameAsc(final Model model) {
        model.addAttribute(USERGROUPS_MODEL_ATTR, userGroupService
                .sortByFields(UserGroup_.name.getName(), Order.ASC));
        return USERGROUP_LIST_URL;
    }
    ...
    public String sortByNameDesc(final Model model) {
        model.addAttribute(USERGROUPS_MODEL_ATTR, userGroupService
                .sortByFields(UserGroup_.name.getName(), Order.DESC));
        return USERGROUP_LIST_URL;
    }
    ...
    public String sortByLevelAsc(final Model model) {
        model.addAttribute(USERGROUPS_MODEL_ATTR, userGroupService
                .sortByFields(UserGroup_.level.getName(), Order.ASC));
        return USERGROUP_LIST_URL;
    }
    ...
    public String sortByLevelDesc(final Model model) {
        model.addAttribute(USERGROUPS_MODEL_ATTR, userGroupService
                .sortByFields(UserGroup_.level.getName(), Order.DESC));
        return USERGROUP_LIST_URL;
    }
     ...
     * @return URL of a page that shows all UserGroups
     */
    @RequestMapping(value = USERGROUP_CREATE_MAPPING,
            method = RequestMethod.POST)
    public String create(
            @ModelAttribute(USERGROUP_MODEL_ATTR) UserGroupDTO userGroupDTO) {
    ...
    public String update(
            @ModelAttribute(USERGROUP_MODEL_ATTR) final UserGroupDTO userGroupDTO) {
    ...
    public String searchByName(
            @ModelAttribute(SEARCH_MODEL_ATTR) UserGroupDTO userGroupDTO,
            Model model) {
        model.addAttribute(USERGROUPS_MODEL_ATTR,
                userGroupService.searchByName(userGroupDTO.getName()));
        return USERGROUP_LIST_URL;
    }
    ...
    public String searchByCurator(
            @ModelAttribute(SEARCH_MODEL_ATTR) UserGroupDTO userGroupDTO,
            Model model) {
        model.addAttribute(USERGROUPS_MODEL_ATTR, userGroupService
                .searchByCurator(userGroupDTO.getCurator().getLastName()));
        return USERGROUP_LIST_URL;
    }
}
