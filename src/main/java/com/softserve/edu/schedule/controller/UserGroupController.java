 ...
 */
@Controller
@RequestMapping(UserGroupControllerConst.USERGROUP_MAPPING)
@SessionAttributes({UserGroupControllerConst.FILTER_MODEL_ATTR,
        UserGroupControllerConst.USERGROUP_PAGINATOR_MODEL_ATTR})
public class UserGroupController {
    ...
    public String showGroupsPage(final Model model,
        ...
        model.addAttribute(UserGroupControllerConst.USERGROUPS_MODEL_ATTR,
                userGroupService.getUserGroupPageWithFilter(userGroupFilter,
                        paginator));
        model.addAttribute(UserGroupControllerConst.USERGROUP_CURATORS_ATTR,
                userService.getAllManagers(activeUsers));
        model.addAttribute(UserGroupControllerConst.FILTER_MODEL_ATTR,
                userGroupFilter);
        model.addAttribute(
                UserGroupControllerConst.USERGROUP_PAGINATOR_MODEL_ATTR,
                paginator);
        model.addAttribute(UserGroupControllerConst.USERGROUP_LEVEL_ATTR,
                Arrays.asList(UserGroupLevel.values()));
    ...
    @RequestMapping(value = UserGroupControllerConst.USERGROUP_SHOW_MAPPING,
            method = RequestMethod.GET)
    public String showGroup(
            @PathVariable(UserGroupControllerConst.PATH_VAR_ID) final Long id,
            final Model model) {
        model.addAttribute(UserGroupControllerConst.USERGROUP_MODEL_ATTR,
                userGroupService.getById(id));
        model.addAttribute(UserGroupControllerConst.USERGROUP_CURATOR_ATTR,
                userGroupService.getById(id).getCurator());
        model.addAttribute(UserGroupControllerConst.USERGROUP_GROUP_MEMBERS,
                userGroupService.getById(id));
    ...
    public String createForm(final Model model) {
        ...
        model.addAttribute(UserGroupControllerConst.USERGROUP_CURATORS_ATTR,
                userService.getAllManagers(activeUsers));
        model.addAttribute(UserGroupControllerConst.USERGROUP_ALL_USERS_ATTR,
                activeUsers);
        model.addAttribute(UserGroupControllerConst.USERGROUP_LEVEL_ATTR,
                Arrays.asList(UserGroupLevel.values()));
     ...
     * @return URL of a page that shows all UserGroups
     */
    @RequestMapping(value = UserGroupControllerConst.USERGROUP_CREATE_MAPPING,
    ...
    public String create(
        ...
        if (result.hasErrors()) {
            model.addAttribute(UserGroupControllerConst.USERGROUP_CURATORS_ATTR,
                    userService.getAllManagers(activeUsers));
            model.addAttribute(
                    UserGroupControllerConst.USERGROUP_ALL_USERS_ATTR,
                    activeUsers);
            model.addAttribute(UserGroupControllerConst.USERGROUP_LEVEL_ATTR,
                    Arrays.asList(UserGroupLevel.values()));
            return UserGroupControllerConst.USERGROUP_CREATE_URL;
            ...
            userGroupService.create(userGroupService
                    .addUserToGroup(userGroupDTO.getCurator(), userGroupDTO));
        }
     ...
     * @return URL of a page that shows all UserGroups
     */
    @RequestMapping(value = UserGroupControllerConst.USERGROUP_EDIT_MAPPING,
            method = RequestMethod.POST)
    public String update(
        ...
        if (result.hasErrors()) {
            ...
            userGroupService.addUserToGroup(userGroupDTO.getCurator(),
                    userGroupDTO);
