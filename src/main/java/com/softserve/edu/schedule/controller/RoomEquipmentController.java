...
public class RoomEquipmentController
    ...
    public String sortByNameASC(Model model) {
        model.addAttribute(ROOM_EQUIPMENTS_MODEL_ATTR,
                roomEquipmentService.sortByName(Order.ASC));
    ...
    public String sortByNameDESC(Model model) {
        model.addAttribute(ROOM_EQUIPMENTS_MODEL_ATTR,
                roomEquipmentService.sortByName(Order.DESC));
        return ROOM_EQUIPMENTS_LIST;
    }
    ...
    public String create(
            @ModelAttribute(ROOM_EQUIPMENT_FORM) RoomEquipmentDTO equipment) {
    ...
    public String updateForm(@PathVariable Long id, Model model) {
        model.addAttribute(ROOM_EQUIPMENT_FORM,
    ...
    public String update(
            @ModelAttribute("equipmentForm") RoomEquipmentDTO equipment) {
