...
<div class="table-responsive">
	...
	<tr>
			<th><spring:message code="lbl.location.name" /> <a
				href="${pageContext.request.contextPath}/locations?sortByField=1&sortOrder=1&pageNumber=0"
				title="<spring:message code="lbl.location.sortAsc" />"><i
					class="fa fa-arrow-circle-o-up fa-lg"></i></a> <a
				href="${pageContext.request.contextPath}/locations?sortByField=1&sortOrder=2&pageNumber=0"
			...
			<th><spring:message code="lbl.location.address" /> <a
				href="${pageContext.request.contextPath}/locations?sortByField=2&sortOrder=1&pageNumber=0"
				title="<spring:message code="lbl.location.sortAsc" />"><i
					class="fa fa-arrow-circle-o-up fa-lg"></i></a> <a
				href="${pageContext.request.contextPath}/locations?sortByField=2&sortOrder=2&pageNumber=0"
				title="<spring:message code="lbl.location.sortDesc" />"><i
					class="fa fa-arrow-circle-o-down fa-lg"></i></a></th>
			<th><spring:message code="lbl.location.coordinates" /></th>
			<th><spring:message code="lbl.location.rooms" /> 
			<a
				...
				title="<spring:message code="lbl.location.sortDesc" />"><i
					class="fa fa-arrow-circle-o-down fa-lg"></i></a>
	...
	<tr>
	<form:form action="${pageContext.request.contextPath}/locations" modelAttribute="${LocationController.FILTER_MODEL_ATTR}">
	<td>
	...
	<td class="v-alighn"><a 
			href="${pageContext.request.contextPath}/locations?name=&address="
	...
	<c:forEach var="location" items="${locations}">
			<tr>
				...
				<td class="text-center v-alighn"><c:if test="${location.rooms.size() == 0}">
						<a
...
<div class="row">
	<div class="col-md-2">
		...
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-default" href="${pageContext.request.contextPath}/locations?pageSize=5&pageNumber=0">5</a>
			</c:otherwise>
		</c:choose>
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-default" href="${pageContext.request.contextPath}/locations?pageSize=10&pageNumber=0">10</a>
			</c:otherwise>
		</c:choose>
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-default" href="${pageContext.request.contextPath}/locations?pageSize=20&pageNumber=0">20</a>
			</c:otherwise>
		</c:choose>	
	</div>
