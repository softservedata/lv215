...
<script type="text/javascript">
	...
	<table class="table table-hover">
		<tr>
			...
			<th class="allInnerForms1">Subject <br>
			...
			<th class="allInnerForms1">Owner <br>
			...
			<th class="allInnerForms2">Date <br>
		...
		<tr>
			...
			<form:form role="form" action="meetings" method="get"
				...
				<td>
					<div class="form-group allInnerForms1" >
						<form:select class="form-control allInnerForms" path="ownerId" id="ownerId">
							<option value="0"></option>
				...
				<td>
					<div class="form-group allInnerForms1">
						<form:select class="form-control allInnerForms" path="roomId" id="roomId">
							<option value="0"></option>
				...
				<td class="levelclass">
					<div class="form-group levelclass">
						<form:input type="number" class="input-number levelclass" path="minLevel" 
							step="1" title="MIN" />
						<form:input type="number" class="input-number levelclass" path="maxLevel"
							step="1" title="MAX" />
					</div>
				</td>
				<!-- Status -->
				<td>
					<div class="form-group">
						<form:select class="form-control allInnerForms" path="status" id="status">
