...
<div class="container">
	<div class="row">
		<div
			...
			<h3 class="text-center"><spring:message code="lbl.subject.edit"/></h3>
			<form:form method="post" modelAttribute="subjectForm">
				...
				<div class="form-group">
					...
					<form:input class="form-control"
						path="${SubjectControllerConst.SUBJECT_PATH_NAME}" 
				...
				<div class="form-group">
					...
					<form:textarea class="form-control"
						path="${SubjectControllerConst.SUBJECT_PATH_DESCRIPTION}" 
