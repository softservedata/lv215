...
<div class="table-responsive">
	<table class="table table-hover">
		<tr>
			<th></th>
			<th><spring:message code="lbl.user.name" />
				<%-- <a
				...
				href="${pageContext.request.contextPath}${UserController.SORT_BY_LASTNAME_DESC_MAPPING}"><i
					class="fa fa-arrow-circle-o-down"></i></a> --%> <a
	...
	<tr>
	<td></td>
	<form:form action="${pageContext.request.contextPath}/users" modelAttribute="${UserController.FILTER_MODEL_ATTR}">
	<td>
...
<div class="row">
	<div class="col-md-2">
		...
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-default" href="${pageContext.request.contextPath}/users?pageSize=5&pageNumber=0">5</a>
			</c:otherwise>
		</c:choose>
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-default" href="${pageContext.request.contextPath}/users?pageSize=10&pageNumber=0">10</a>
			</c:otherwise>
		</c:choose>
		<c:choose>
			...
			<c:otherwise>
				<a class="btn btn-default" href="${pageContext.request.contextPath}/users?pageSize=20&pageNumber=0">20</a>
			</c:otherwise>
		</c:choose>	
	</div>
