...
<spring:url value="/resources/js/users/users.js" var="usersListJS" />
<script>
	var totalPages = ${userPaginator.pagesCount + 1}
	var startPage = ${userPaginator.pageNumber + 1}
</script>
<script type="text/javascript" src="${usersListJS}">
