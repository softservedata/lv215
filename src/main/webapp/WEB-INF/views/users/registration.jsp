				...
				<form:form method="post"
					...
					<div class="form-group">
						...
						<form:input type="text" class="form-control" path="firstName"
							...
							pattern="[а-яА-ЯёЁіІєЄїЇa-zA-Z\\'\\-]{2,25}"
					...
					<div class="form-group">
						...
						<form:input type="text" class="form-control" path="phone"
							placeholder="${nameForPlaceholder}" pattern="\d{3}-\d{7}"
							title="${wrongPhonNamber}" required="true" />
					...
					<div class="form-group">
						<label for="confirmPassword"><spring:message
								code="lbl.user.confirmPassword" />:</label>
						<spring:message code="lbl.user.confirmPassword"
							var="nameForPlaceholder" />
						<form:input type="password" class="form-control"
							path="confirmPassword" placeholder="${nameForPlaceholder}"
							required="true" />
