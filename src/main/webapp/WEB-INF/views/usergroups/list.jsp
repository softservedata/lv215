	...
	<table class="table table-hover">
		<tr>
			<th>
				...
				<a href="usergroups?fieldForSorting=1&sortOrder=0&pageNumber=0" title="Sort Ascending">
					<i class="fa fa-arrow-circle-o-up fa-lg"></i>
				</a>
				<a href="usergroups?fieldForSorting=1&sortOrder=1&pageNumber=0" title="Sort Descending">
					<i class="fa fa-arrow-circle-o-down fa-lg"></i>
				</a>
			</th>

			<th>
				<spring:message code="lbl.group.curator" />
			</th>

			<th>
				<spring:message code="lbl.group.level" />
				<a href="usergroups?fieldForSorting=3&sortOrder=0&pageNumber=0" title="Sort Ascending">
					<i class="fa fa-arrow-circle-o-up fa-lg"></i>
				</a>
				<a href="usergroups?fieldForSorting=3&sortOrder=1&pageNumber=0" title="Sort Descending">
					<i class="fa fa-arrow-circle-o-down fa-lg"></i>
				</a>
			</th>

			<th>
				<spring:message code="lbl.group.members" />
				<a href="usergroups?fieldForSorting=4&sortOrder=0&pageNumber=0" title="Sort Ascending">
					<i class="fa fa-arrow-circle-o-up fa-lg"></i>
				</a>
				<a href="usergroups?fieldForSorting=4&sortOrder=1&pageNumber=0" title="Sort Descending">
					<i class="fa fa-arrow-circle-o-down fa-lg"></i>
				</a>
			</th>
			...
			<th>
				<a href="${pageContext.request.contextPath}/usergroups/create">
		...
		<tr>
			<form:form action="${pageContext.request.contextPath}/usergroups"
				...
				<td>
					<spring:message code="lbl.group.search" var="search" />
					<form:input class="form-control" path="name" placeholder=" ${search}" />
				</td>

				<td>
					<form:select class="form-control" path="curatorId">
						...
						<c:forEach items="${curators}" var="curator">
							<c:choose>
								...
								<c:otherwise>
									<option value="${curator.id}">${curator.firstName}${curator.lastName}</option>
								</c:otherwise>
							</c:choose>
						</c:forEach>
					</form:select>
				...
				<td>
					<form:select class="form-control" path="levelId">
						...
						<c:forEach items="${levels}" var="level">
							<c:choose>
								...
								<c:otherwise>
									<option value="${level.ordinal()}"><spring:message code="lbl.group.${level.code}" /></option>
								</c:otherwise>
							</c:choose>
						</c:forEach>
					</form:select>
			...
			<td class="v-alighn">
				<a href="${pageContext.request.contextPath}/usergroups?name=&curator=&levelId="
		...
		<c:forEach var="usergroup" items="${usergroups}">
			<tr>
				<td>
					<a href="${pageContext.request.contextPath}/usergroups/${usergroup.id}">${usergroup.name}</a>
				</td>
				<td>
					<a href="${pageContext.request.contextPath}/profile${usergroup.curator.id}">${usergroup.curator.lastName}
						${usergroup.curator.firstName}</a>
				</td>
				<td>
					<spring:message code="lbl.group.${usergroup.level.code}" />
				</td>
				<td>${usergroup.users.size()}</td>

				<td>
					<a href="${pageContext.request.contextPath}/usergroups/delete/${usergroup.id}">
						<i class="fa fa-trash-o fa-lg"></i>
					</a>
				</td>

				<td>
					<a href="${pageContext.request.contextPath}/usergroups/edit/${usergroup.id}">
	...
	<div class="col-md-2">
		...
		<c:choose>
			<c:when test="${usergroupPaginator.pageSize eq 10}">
				<a class="btn btn-primary" href="usergroups?pageSize=10&pageNumber=0">10</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-default" href="usergroups?pageSize=10&pageNumber=0">10</a>
			</c:otherwise>
		</c:choose>
		<c:choose>
			<c:when test="${usergroupPaginator.pageSize eq 20}">
				<a class="btn btn-primary" href="usergroups?pageSize=20&pageNumber=0">20</a>
			</c:when>
			<c:otherwise>
				<a class="btn btn-default" href="usergroups?pageSize=20&pageNumber=0">20</a>
			</c:otherwise>
		</c:choose>
	</div>
